...
export default function Players({ isConnected, players }) {
    ...
    useEffect(() => {
        const sortArray = (type) => {
            ...
            const sorted = [...players].sort((a, b) => (a[sortProperty] < b[sortProperty] ? 1 : -1));
            setData(sorted);
        };
        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.sort__buttons}>
                    <button value="currentrating2v2" onClick={(e) => setSortType(e.target.value)}>
                        Sort by 2v2
                    </button>
                    <button value="currentrating3v3" onClick={(e) => setSortType(e.target.value)}>
                        Sort by 3v3
                    </button>
                    <button value="currentratingrbg" onClick={(e) => setSortType(e.target.value)}>
                        Sort by RBG
                    </button>
                </div>
            ...
            <footer className={styles.footer}>
                <a href="https://github.com/toremann/nextjs-wowpvp" rel="noopener noreferrer">
